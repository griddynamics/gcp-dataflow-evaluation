...
public class PipelineJava {
    ...
    // paths to input data
    static String inUsersAvro = "..."
    static String inOrdersAvro = "..."
    ...
    public static void main(String[] args) {
        ...
        PCollection<User> user = p
                .apply(
                        "Read users", AvroIO.read(User.class).from(inUsersAvro));

        PCollection<Order> orders = p
                .apply(
                "Read orders", AvroIO.read(Order.class).from(inOrdersAvro));
